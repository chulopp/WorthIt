...
class _DecisionSheet extends ConsumerWidget {
  ...
  Widget _gauge(ProductAnalysis a, Color c) => Container(
    ...
    decoration: BoxDecoration(
      ...
      gradient: RadialGradient(
        colors: [c.withValues(alpha: 0.25), Colors.transparent],
        radius: 0.85,
      ),
  ...
  Widget _insights(ProductAnalysis a) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(
        'decision_sheet.insights'.tr(),
        style: GoogleFonts.poppins(
          fontSize: 14,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [ac.withValues(alpha: 0.12), ac.withValues(alpha: 0.04)],
        ),
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  'decision_sheet.substitute_suggestion'.tr(),
                  style: GoogleFonts.poppins(
                    fontSize: 14,
                    fontWeight: FontWeight.w600,
                    color: ac,
          ...
          _r(
            'decision_sheet.weight'.tr(),
            '${s.weightGram.toStringAsFixed(0)}g',
          ),
          _r(
            'decision_sheet.price_per_gram'.tr(),
            'Rp${s.pricePerGram.toStringAsFixed(2)}/g',
          ),
          const SizedBox(height: 8),
          Container(
  ...
  Widget _actions(BuildContext ctx) => Row(
    children: [
      Expanded(
