...
class FaqScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> faqList = [
      {'question': 'faq.q1'.tr(), 'answer': 'faq.a1'.tr()},
      {'question': 'faq.q2'.tr(), 'answer': 'faq.a2'.tr()},
      {'question': 'faq.q3'.tr(), 'answer': 'faq.a3'.tr()},
      {'question': 'faq.q4'.tr(), 'answer': 'faq.a4'.tr()},
      {'question': 'faq.q5'.tr(), 'answer': 'faq.a5'.tr()},
