...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _performLogout() async {
    showDialog<void>(
      ...
      builder: (_) => const Center(
        child: CircularProgressIndicator(color: Color(0xFF304423)),
      ),
    );
    ...
    try {
      ...
      container.invalidate(historyControllerProvider);
      container.invalidate(shoppingListControllerProvider);
      ...
      container.invalidate(productDetailControllerProvider);
      if (!context.mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    final displayName =
        ...
        (emailName == null || emailName.isEmpty ? null : emailName) ??
        'guest'.tr();
