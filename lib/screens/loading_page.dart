...
/// Post-login transition screen with premium animated blurred glowing blobs.
///
/// Auto-navigates to the dashboard after a short delay.
class LoadingPage extends StatefulWidget {
  final bool isGuest;
  const LoadingPage({Key? key, this.isGuest = false}) : super(key: key);
